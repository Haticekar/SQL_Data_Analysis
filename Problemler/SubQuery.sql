...
SELECT
    ...
    CASE
        ...
        WHEN job_count < 50 AND job_count > 10 THEN 'Meidum'
        ELSE 'Large'
    END AS categorize
FROM(
    -- firstly we wrote this part
    SELECT
...
/*
3- Find companies that offer an average salary above the overall average yearly salary of all job postings. Use subqueries to select companies with an average salary higher than the overall average salary (which is another subquery).
